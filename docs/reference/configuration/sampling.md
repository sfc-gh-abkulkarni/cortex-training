...
`vllm_config.speculative_config` enables speculative decoding. Pass the draft
model as an `<org>/<model>` Hub id, the same convention as `model_name`. See
[InferenceConfig](../rest-api.md#83-inferenceconfig).
